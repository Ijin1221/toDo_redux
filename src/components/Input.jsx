  ...
  return (
    <>
      <div className='border-3 rounded-2xl border-[rgb(51,95,112)] w-[90%] flex'>
        <input type="text" placeholder='Enter Your Task' className='flex-1 rounded-l-2xl ps-4 text-white text-[12px] md:text-[15px] lg:text-[20px]' onChange={(e) => setInputValue(e.target.value)} value={inputValue} />
